    ...
    export default {
        ...
        methods: {
            ...
            createTutorial() {
                ...
                this.observers.forEach((x,index )=> {
                        form.set('observers[' + index + '][observer_id]', x.value)

                    }
                )
                this.moderators.forEach((x,index )=> {
                        form.set('moderators[' + index + '][moderator_id]', x.value)
                ...
                this.axios.post('/tutorials', form).then(response => {
                    ...
                    if (this.moderators && this.moderators.some(x => x.value === this.$store.state.userID)) {
