...
class TrainingController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        if ($request->file('file')) {
            ...
            $fileName = generateFileName(TrainingController::DIRECTORY, $file->getExtension());
        ...
        return $training->load(['observers.user', 'participants.participant', 'file', 'tutorial']);
    }
    public function getById($id)
    {
        return parent::getById($id)->load(['observers.user', 'participants']); // TODO: Change the autogenerated stub
    }
