...
class TrainingController extends Controller
{
    ...
    {
        $request['originator_id'] = app()->session_id;
        ...
        // return $training->load(['observers.user', 'participants.participant', 'originator']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($participants) {
            ...
            dispatch(new NotifyParticipantsJob($training->toArray(), array_column($participants, 'participant_id')));
        }
        $file = $request->file('file');
        if ($file) {
